...
const GROUP_THREAD_ID = "25272934338957475";        // Group ka ID
const LOCKED_GROUP_NAME = "SALMAN + MANO RANDI + SUKOON RANDI + IMMU + SARKAR GANG KI MAA CHODNE WALA HERE 😹💪";     // Locked name
